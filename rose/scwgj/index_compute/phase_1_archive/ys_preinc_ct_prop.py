...
def ys_preinc_ct_prop(entry: Entry, param: Parameter, logger):
    ...
    sql = f'''
        select corp_code, count(distinct rptno) as c18
          from (
                select corp_code, tx_amt_usd, rptno
                  from pboc_corp_rcv_jn_v
    ...
    sql = """
        select 
            ...
            ,case when v1.c17 is null and v2.c18 is null then null else coalesce(v1.c17, 1)/coalesce(v2.c18, 1) end ys_preinc_ct_prop
