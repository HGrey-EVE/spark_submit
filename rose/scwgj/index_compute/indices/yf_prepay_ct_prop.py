...
@register(name="yf_prepay_ct_prop",
          persistent="parquet",
          persistent_param={"mode": "overwrite"},
          dependencies=["target_company_v", "pboc_corp_pay_jn_v"])
def yf_prepay_ct_prop(entry: Entry, param: Parameter, logger):
    ...
    sql = """
        select 
            ...
            ,case when v1.c15 is null and v2.c36 is null then null else coalesce(v1.c15, 1)/coalesce(v2.c36, 1) end yf_prepay_ct_prop
