                            ...
                            from (
                                ...
                                from (
                                    select distinct corp_code, 
                                        substring(cp_rcver_name, 5, 20) as new_cp_payer_name
