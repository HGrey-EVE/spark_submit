...
@register(name="export_txamt_dealamt_prop",
          persistent="parquet",
          persistent_param={"mode": "overwrite"},
          dependencies=["target_company_v", "pboc_imp_custom_rpt_v", "pboc_corp_rcv_jn_v"])
def export_txamt_dealamt_prop(entry: Entry, param: Parameter, logger):
    ...
    sql = """
        select 
            ...
            ,case when v1.c1 is null and v2.c8 is null then null else coalesce(v1.c1, 1)/coalesce(v2.c8, 1) end export_txamt_dealamt_prop
